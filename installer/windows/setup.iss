; ──────────────────────────────────────────────────────────────────────────────
;  NETMAX — Windows Installer (Inno Setup 6)
;  Built by CI from: build\windows\x64\runner\Release\
; ──────────────────────────────────────────────────────────────────────────────

#define MyAppName      "NETMAX"
#define MyAppVersion   "1.0.0"
#define MyAppPublisher "NETMAX"
#define MyAppExeName   "NETMAX.exe"
...
OutputDir=Output
OutputBaseFilename=NETMAX-Windows-Setup
